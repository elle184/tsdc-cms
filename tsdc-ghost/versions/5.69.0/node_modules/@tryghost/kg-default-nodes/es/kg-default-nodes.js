import { DecoratorNode, $getRoot, ElementNode, TextNode, $isTextNode } from 'lexical';
...
function cardTemplate$3(nodeData) {
...
function renderHeaderNodeV2(dataset, options = {}) {
  ...
  const htmlString = cardTemplate$3(node);
  const element = document.createElement('div');
  element.innerHTML = htmlString?.trim();
  if (node.header === '') {
...
const DEFAULT_NODES = [ExtendedTextNode, extendedTextNodeReplacement, ExtendedHeadingNode, extendedHeadingNodeReplacement, CodeBlockNode, ImageNode, MarkdownNode, VideoNode, AudioNode, CalloutNode, AsideNode, HorizontalRuleNode, HtmlNode, FileNode, ToggleNode, ButtonNode, HeaderNode, BookmarkNode, PaywallNode, ProductNode, EmbedNode, EmailNode, GalleryNode, EmailCtaNode, SignupNode, CollectionNode];

export { $createAsideNode, $createAudioNode, $createBookmarkNode, $createButtonNode, $createCalloutNode, $createCodeBlockNode, $createCollectionNode, $createEmailCtaNode, $createEmailNode, $createEmbedNode, $createFileNode, $createGalleryNode, $createHeaderNode, $createHorizontalRuleNode, $createHtmlNode, $createImageNode, $createMarkdownNode, $createPaywallNode, $createProductNode, $createSignupNode, $createToggleNode, $createVideoNode, $isAsideNode, $isAudioNode, $isBookmarkNode, $isButtonNode, $isCalloutNode, $isCodeBlockNode, $isCollectionNode, $isEmailCtaNode, $isEmailNode, $isEmbedNode, $isFileNode, $isGalleryNode, $isHeaderNode, $isHorizontalRuleNode, $isHtmlNode, $isImageNode, $isKoenigCard, $isMarkdownNode, $isPaywallNode, $isProductNode, $isSignupNode, $isToggleNode, $isVideoNode, AsideNode, AudioNode, BookmarkNode, ButtonNode, CalloutNode, CodeBlockNode, CollectionNode, DEFAULT_NODES, EmailCtaNode, EmailNode, EmbedNode, ExtendedHeadingNode, ExtendedTextNode, FileNode, GalleryNode, HeaderNode, HorizontalRuleNode, HtmlNode, ImageNode, KoenigDecoratorNode, MarkdownNode, PaywallNode, ProductNode, SignupNode, ToggleNode, VideoNode, extendedHeadingNodeReplacement, extendedTextNodeReplacement };
